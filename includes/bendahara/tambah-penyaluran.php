<?php
  ...
  if(isset($_POST['simpan'])){
    ...
    if(tambah($_POST) > 0){
        ...
        echo "<script>alert('Gagal!');document.location='tambah-penyaluran.php';</script>";
    }
                        ...
                        <div class="row">
                          <div class="form-group col-md-6 mb-2">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control" required name="jml_uang" placeholder="Contoh : 350000">
                            </div>
                          </div>
                          <div class="form-group col-md-6 mb-2">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control" name="jml_beras" required placeholder="Contoh : 4.5">
                            </div>
                          </div>
                        </div>
