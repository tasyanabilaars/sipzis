<?php
  ...
  $id = $_GET['id_sedekah'];
  $query = "SELECT * FROM sedekah WHERE id_sedekah='$id'";
...
<!DOCTYPE html>
<html lang="id">
    <title>Cek Transaksi Sedekah | SIPZIS</title>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                      <div class="row">
                          <input type="hidden" name="id_sedekah" value='<?php echo $row["id_sedekah"]; ?>' >
                        </div>
                        <div class="row">
                          ...
                          <div class="form-group col-md-12 mb-2">
                            ...
                            <input type="text" class="form-control"  name="nama"  value="<?= $row['nama']; ?>" readonly="readonly"required />
                          </div>
                        </div>
                        <div class="row">
                          <div class="form-group col-md-12 mb-2">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-12 mb-2">
                            ...
                            <input type="text" class="form-control" name="total" value="<?= $row['total_donasi']; ?>" readonly="readonly" required>
                          </div>
                        </div>
                        <div class="row">
                          <div class="form-group col-md-12 mb-2">
