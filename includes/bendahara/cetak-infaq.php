...
$data = mysqli_query($koneksi, "SELECT * FROM (user LEFT JOIN infaq ON user.username=infaq.username) WHERE tgl_donasi BETWEEN '$tglawal' AND '$tglakhir' ORDER BY tgl_donasi ASC ");
