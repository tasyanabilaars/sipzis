                      ...
                      <form action="act-zakat.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 mb-2">
                            ...
                            <input type="text" class="form-control"  name="nama_kk" placeholder="Nama Kepala Keluarga" required />
                          </div>
                        </div>
                        <div class="row">
                          <div class="form-group col-md-6 mb-2">
                        ...
                        <div class="row">
                        <input type="hidden" class="form-control" name="jenis_zakat" value="zakat_beras" readonly="readonly" required>
                          <div class="form-group col-md-6 mb-3">
                            <label for="pilihan_beras" class="form-label">Nilai Zakat</label>
                              <select class="custom-select" name="pilihan_beras" required>
