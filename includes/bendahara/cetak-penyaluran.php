...
$data = mysqli_query($koneksi, "SELECT * FROM penerimaan WHERE tgl_penerima BETWEEN '$tglawal' AND '$tglakhir' ORDER BY id_penyaluran ASC ");
while ($row=$data->fetch_array()) {
    ...
    $pdf->Cell(4.5, 0.8, "Rp. ".number_format($row['jml_uang']).",-", 1, 0, 'C');
    $pdf->Cell(4.5, 0.8, $row['jml_beras'], 1, 0, 'C');
