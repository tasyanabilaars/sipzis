<?php
  ...
  $query = "SELECT * FROM penerimaan where id_penyaluran=$id";
                        ...
                        <div class="row">
                          <div class="form-group col-md-6 mb-2">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  required name="jml_uang" id="inlineFormInputGroup" placeholder="Contoh : 350000">
                            </div>
                          </div>
                          <div class="form-group col-md-6 mb-2">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control"  required name="jml_beras" id="inlineFormInputGroup" placeholder="Contoh : 4.5">
                            </div>
                          </div>
                        </div>
