...
$data = mysqli_query($koneksi, "SELECT * FROM donasi JOIN sedekah ON donasi.id_donasi = sedekah.id_donasi WHERE tgl_donasi BETWEEN '$tglawal' AND '$tglakhir' AND jenis_donasi = 'sedekah' AND status IN (2) ORDER BY id_sedekah,tgl_donasi ASC");
while ($row=$data->fetch_array()) {
    ...
    $pdf->Cell(5, 0.8, $row['nama_donatur'], 1, 0, 'C');
