...
$data = mysqli_query($koneksi, "SELECT * FROM user JOIN infaq ON user.id_user = infaq.id_user WHERE tgl_donasi BETWEEN '$tglawal' AND '$tglakhir' AND status IN (2) ORDER BY tgl_donasi ASC");
