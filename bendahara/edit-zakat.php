                  ...
                  <div class="card-body">
                    <div class="alert alert-info">
                      ...
                      <div class="row">
                        ...
                        <input type="hidden" class="form-control" name="jenis_donasi" value="<?= $row['jenis_donasi'];?>" readonly="readonly" required>
                        <div class="row">
                          <div class="form-group col-md-6 mb-3">
                            <label for="pilihan_beras" class="form-label">Nilai Zakat</label>
                            <input type="text" class="form-control" name="nilai_zakat" value="2.5" readonly="readonly" id="nilai_1" onkeyup="sum();" required>
                          </div>
                          <div class="form-group col-md-6 mb-2">
