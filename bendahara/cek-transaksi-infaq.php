<?php
  ...
  $id = $_GET['id_infaq'];
  $query = "SELECT * FROM user,infaq WHERE user.id_user = infaq.id_user AND id_infaq='$id'";
...
<html lang="id">
  ...
  <title>Cek Pembayaran Infaq | SIPZIS</title>
  <body>
    <div id="app">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="form-group col-md-12 mb-2">
                          ...
                          <br>
                          <center><img src="../berkas/bukti/bukti-infaq/<?php echo $row['bukti_donasi']; ?>" class="img-responsive zoom" width="20%"></center>
                        </div>
                        <div class="form-group col-md-12 mb-2">
                          <label>Status</label>
