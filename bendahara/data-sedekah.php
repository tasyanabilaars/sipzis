              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                  <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                      <div class="card-header">
                        <h4>Donasi Sedekah Bulan Ini</h4>
                      </div>
                      <div class="card-body" style="font-size:15px;">
                        <?php 
                        $bulan = date('m');
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered table-md">
                          ...
                          <?php
                            ...
                            $data_sedekah = mysqli_query($koneksi, "SELECT * FROM donasi,sedekah WHERE donasi.id_donasi = sedekah.id_donasi AND jenis_donasi='sedekah' ORDER BY tgl_donasi DESC LIMIT $halaman_awal,$batas");
