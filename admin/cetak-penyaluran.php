...
$data = mysqli_query($koneksi, "SELECT * FROM penyaluran WHERE tgl_penerima BETWEEN '$tgl_dari' AND '$tgl_sampai' ORDER BY id_penyaluran ASC ");
...
$data = mysqli_query($koneksi, "SELECT * FROM penyaluran WHERE tgl_penerima BETWEEN '$tgl_dari' AND '$tgl_sampai' ");
$jumlah = 0;
$jumlahberas = 0;
