        ...
        <div class="main-content">
          <section class="section">
            ...
            <div class="section-body">
              ...
              <div class="row">
                  ...
                  <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                      <div class="card-header">
                        <h4>Donasi Sedekah Hari Ini</h4>
                      </div>
                      <div class="card-body" style="font-size:15px;">
                        <?php 
                        $tanggal = date('Y-m-d');
                        $data=mysqli_query($koneksi,"SELECT sum(total) AS total FROM donasi WHERE jenis_donasi='sedekah' AND status IN(2) AND tgl_donasi='$tanggal'");
                  ...
                  <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                      ...
                      <div class="card-body" style="font-size:15px;">
                        <?php 
                        $bulan = date('m');
                        $data=mysqli_query($koneksi,"SELECT sum(total) AS total FROM donasi WHERE jenis_donasi='sedekah' AND status IN(2) AND month(tgl_donasi)='$bulan'");
                        $result=mysqli_fetch_array($data);
                        echo "Rp. ". number_format($result['total'])." ,-";?>
                      </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                  <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                      <div class="card-header">
                        <h4>Donasi Sedekah Tahun Ini</h4>
                      </div>
                      <div class="card-body" style="font-size:15px;">
                        <?php 
                        $tahun = date('Y');
                        $data=mysqli_query($koneksi,"SELECT sum(total) AS total FROM donasi WHERE jenis_donasi='sedekah' AND status IN(2) AND year(tgl_donasi)='$tahun'");
                        $result=mysqli_fetch_array($data);
                        echo "Rp. ". number_format($result['total']).",-";?>
                      </div>
                    </div>
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered table-md">
                          ...
                          <?php
                            ...
                            $data_sedekah = mysqli_query($koneksi, "SELECT * FROM donasi,sedekah WHERE donasi.id_donasi = sedekah.id_donasi AND jenis_donasi='sedekah' and date(tgl_donasi)>='$tgl_dari' and date(tgl_donasi)<='$tgl_sampai' ORDER BY tgl_donasi DESC LIMIT $halaman_awal,$batas");
                        ...
                        <a href="cetak-sedekah.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>" target="_blank" class="btn btn-lg btn-danger"><i class="fa fa-file-pdf"></i> &nbsp CETAK PDF</a>   
                      </div>
                    </div>
              ...
              <div>
                <?php
                  $data=mysqli_query($koneksi,"SELECT sum(total) as total from donasi WHERE jenis_donasi='sedekah' AND date(tgl_donasi)>='$tgl_dari' AND date(tgl_donasi)<='$tgl_sampai' AND status IN(2)");
                  $result=mysqli_fetch_array($data);?>
