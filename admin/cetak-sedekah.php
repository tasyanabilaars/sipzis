...
$data = mysqli_query($koneksi, "SELECT * FROM donasi,sedekah WHERE donasi.id_donasi = sedekah.id_donasi AND jenis_donasi = 'sedekah'  AND date(tgl_donasi)>='$tgl_dari' AND date(tgl_donasi)<='$tgl_sampai'  AND status IN (2) ORDER BY id_sedekah,tgl_donasi ASC");
