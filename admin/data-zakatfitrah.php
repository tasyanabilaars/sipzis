        ...
        <div class="main-content">
          <section class="section">
            ...
            <div class="section-body">
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered table-md text-center">
                          ...
                          <?php
                            ...
                            $data_zakat = mysqli_query($koneksi, "SELECT * FROM donasi,zakatfitrah WHERE donasi.id_donasi = zakatfitrah.id_donasi AND jenis_donasi='zakat_uang' and date(tgl_donasi)>='$tgl_dari' and date(tgl_donasi)<='$tgl_sampai' ORDER BY tgl_donasi DESC LIMIT $halaman_awal,$batas");
                        ...
                        <a href="cetak-zakatfitrah.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>" target="_blank" class="btn btn-lg btn-danger"><i class="fa fa-file-pdf"></i> &nbsp CETAK PDF</a>       
                      </div>
                    </div>
              ...
              <div class="mb-2 mt-2">
              <?php
                   $data=mysqli_query($koneksi,"SELECT sum(total) as total from donasi WHERE jenis_donasi = 'zakat_uang' AND date(tgl_donasi)>='$tgl_dari' AND date(tgl_donasi)<='$tgl_sampai' AND status IN (2)");
                  $result=mysqli_fetch_array($data);?>
